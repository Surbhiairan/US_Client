...
import { getCollectionDetail, getPostsList, getCollectionFollowing } from '../../collection/collection.action';
...
class UserCollectionDetail extends React.Component {
...
export default compose(withStyles(styles), connect(mapStateToProps, mapDispatchToProps))(UserCollectionDetail);