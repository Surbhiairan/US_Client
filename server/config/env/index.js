...
// parses mysql connection string (e.g. mysql://<username>:<password>@host:port/database)
// lifted from Sequelize (https://github.com/sequelize/sequelize/blob/master/lib/sequelize.js)
